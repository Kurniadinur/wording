		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-left">
					...
					<li>
							<li><a href="produksi.php"> <i class="glyphicon glyphicon-retweet"></i> Daftar Pesanan</a></li>
					</li>
					...
					<li>
							<li><a href="halaman_bot.php"> <i class="glyphicon glyphicon-user"></i> Bot</a></li>
					</li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class=""></i> Admin <span class="caret"></span></a>
						<ul class="dropdown-menu">
